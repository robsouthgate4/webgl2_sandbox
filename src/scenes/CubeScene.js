...
import Phong from '../shaders/phong/phong'
...
export default class CubeScene {
    ...
    _setup() {        
        ...
        const vsSource = Phong.vertexShader;
        const fsSource = Phong.fragmentShader;
        ...
        const box           =  utils.createBox( { dimensions: [ 1.0, 1.0, 1.0 ] });
        this.numVertices   = box.positions.length / 3;
        ...
        this.gl.bufferData( this.gl.ARRAY_BUFFER, box.positions, this.gl.STATIC_DRAW );
        this.gl.vertexAttribPointer( 0, 3, this.gl.FLOAT, false, 0, 0 );
        this.gl.enableVertexAttribArray( 0 );

        const uvBuffer = this.gl.createBuffer();
        this.gl.bindBuffer( this.gl.ARRAY_BUFFER, uvBuffer );
        this.gl.bufferData( this.gl.ARRAY_BUFFER, box.uvs, this.gl.STATIC_DRAW );
        this.gl.vertexAttribPointer( 1, 2, this.gl.FLOAT, false, 0, 0 );
        this.gl.enableVertexAttribArray( 1 );

        const normalBuffer = this.gl.createBuffer();
        this.gl.bindBuffer( this.gl.ARRAY_BUFFER, normalBuffer );
        this.gl.bufferData( this.gl.ARRAY_BUFFER, box.normals, this.gl.STATIC_DRAW );
