...
export default class StatueSceneLayers {
    ...
    _setup() {       
        ...
        this.numVertices    = statue.positions.length / 3;
        ...
        gl.bufferData( gl.ARRAY_BUFFER, statue.positions, gl.STATIC_DRAW );
        ...
        gl.bufferData( gl.ARRAY_BUFFER,  statue.uvs, gl.STATIC_DRAW );
        gl.vertexAttribPointer( 1, 2, gl.FLOAT, false, 0, 0 );
        gl.enableVertexAttribArray( 1 );

        const normalBuffer = gl.createBuffer();
        gl.bindBuffer( gl.ARRAY_BUFFER, normalBuffer );
        gl.bufferData( gl.ARRAY_BUFFER, statue.normals, gl.STATIC_DRAW );
        ...
        gl.bufferData( gl.ELEMENT_ARRAY_BUFFER, statue.indices, gl.STATIC_DRAW );
        ...
        const eyePosition    = vec3.fromValues( 1, 5, 3 );
    ...
    draw( time ) {
        ...
        if ( this.elapsed > this.fpsInterval ) {
...

            {
                ...
                gl.drawElements( gl.TRIANGLES, this.numOfStatueElements, gl.UNSIGNED_SHORT, 0 );
